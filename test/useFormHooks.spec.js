...
describe('Form Hooks', () => {
  ...
  function mountComponent(customProps = {}) {
    ...
    const wrapper = render(<FormFlowProvider children={<Children capture={capture} submit={submit} />} {...props} />);
  ...
  test('if submits form', async () => {
    ...
    fireEvent.change(
      scenario.wrapper.container.querySelectorAll('input[type="text"]')[1],
      { target: { value: '30' } }
    );
